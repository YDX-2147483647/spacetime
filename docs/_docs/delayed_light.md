...
考虑 $ \triangle E_0 E_1 H_1 $。以 $E_0$ 为原点，则 $E_1 (0, T)$，$H_1 (x_{H_1}, T')$。由于 $E_1 H_1$ 是电磁脉冲的世界线，$x_{H_1} = c (T'-T)$；由于 $E_0 H_1$ 是水滴的世界线，$x_{H_1} = v T'$。联立解得 $1 - T/T' = v/c$，$T' = T / \left( 1 - \frac{v}{c} \right)$。
